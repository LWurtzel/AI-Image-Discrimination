...
- A **ResNet50V2** transfer-learning model trained across **three** generators from the larger **GenImage** dataset generalizes much better — **~79% average accuracy across all eight generators** — but still reaches lower accuracies on the generators it didn't train on.
